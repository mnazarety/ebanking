...
$client_id = $_SESSION['client_id'];
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  client_id = ? AND tr_type = 'Deposit' ";
$stmt = $mysqli->prepare($result);
...
$client_id = $_SESSION['client_id'];
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  client_id = ? AND tr_type = 'Withdrawal' ";
$stmt = $mysqli->prepare($result);
$stmt->bind_param('i', $client_id);
$stmt->execute();
...
$client_id = $_SESSION['client_id'];
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  client_id = ? AND tr_type = 'Transfer' ";
$stmt = $mysqli->prepare($result);
$stmt->bind_param('i', $client_id);
$stmt->execute();
...
$client_id = $_SESSION['client_id'];
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions  WHERE client_id =?";
$stmt = $mysqli->prepare($result);
$stmt->bind_param('i', $client_id);
$stmt->execute();
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped table-hover m-0">
                      ...
                      <tbody>
                        ...
                        $client_id = $_SESSION['client_id'];
                        $ret = "SELECT * FROM tbl_transactions WHERE  client_id = ?  ORDER BY tbl_transactions. created_at DESC ";
        ...
        data: [{
          ...
          dataPoints: [{
              y: <?php
                  ...
                  $client_id = $_SESSION['client_id'];
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type ='Savings' AND client_id =? ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $client_id);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $client_id  = $_SESSION['client_id'];
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type =' Retirement' AND client_id =? ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $client_id);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $client_id  = $_SESSION['client_id'];
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type ='Recurring deposit' AND client_id =? ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $client_id);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $client_id  = $_SESSION['client_id'];
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type ='Fixed Deposit Account' AND client_id = ? ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $client_id);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $client_id  = $_SESSION['client_id'];
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type ='Current account' AND client_id =? ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $client_id);
                  $stmt->execute();
        ...
        data: [{
          ...
          dataPoints: [{
              y: <?php
                  ...
                  $client_id  = $_SESSION['client_id'];
                  $result = "SELECT count(*) FROM tbl_transactions WHERE  tr_type ='Withdrawal' AND client_id =? ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $client_id);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $client_id  = $_SESSION['client_id'];
                  $result = "SELECT count(*) FROM tbl_transactions WHERE  tr_type ='Deposit' AND client_id =? ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $client_id);
                  $stmt->execute();
...

            {
              y: <?php
                  //return total number of transactions under  Deposits
                  $client_id  = $_SESSION['client_id'];
                  $result = "SELECT count(*) FROM tbl_transactions WHERE  tr_type ='Transfer' AND client_id =? ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->bind_param('i', $client_id);
                  $stmt->execute();
