...
if (isset($_POST['create_account'])) {
  ...
  $query = "INSERT INTO tbl_clients (name, national_id, client_number, phone, email, password, address) VALUES (?,?,?,?,?,?,?)";
    ...
    <div class="login-box">
      ...
      <div class="card">
        <div class="card-body login-card-body">
          <p class="login-box-msg">Sign Up To Use eBank Kenya</p>
          ...
          <form method="post">
            ...
            <div class="input-group mb-3" style="display:none">
              ...
              <input type="text" name="client_number" value="eBank-CLIENT-<?php echo $_Number; ?>" class="form-control" placeholder="Client Number">
              <div class="input-group-append">
                <div class="input-group-text">
