...
if (isset($_POST['open_account'])) {
    ...
    $query = "INSERT INTO tbl_bankaccounts (acc_name, account_number, acc_type, acc_rates, acc_status, acc_amount, client_id, client_name, client_national_id, client_phone, client_number, client_email, client_adr) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <?php
        $client_id = $_SESSION['client_id'];
        $ret = "SELECT * FROM  tbl_clients WHERE client_id = ? ";
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Open <?php echo $row->name; ?> eBank Account</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                                    <li class="breadcrumb-item"><a href="pages_open_acc.php">eBank Accounts</a></li>
                                ...
                                <div class="card card-purple">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class=" col-md-6 form-group">
                                                    <label for="exampleInputEmail1">eBank Account Type</label>
                                                    <select class="form-control" onChange="geteBankAccs(this.value);" name="acc_type">
                                                        <option>Select Any eBank Account Types</option>
                                                        <?php
                                                        //fetch all tbl_acc_types
                                                        $ret = "SELECT * FROM  tbl_acc_types ORDER BY RAND() ";
                                                        $stmt = $mysqli->prepare($ret);
                                                        $stmt->execute(); //ok
                                                        $res = $stmt->get_result();
                                                        $cnt = 1;
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="open_account" class="btn btn-success">Open eBank Account</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
