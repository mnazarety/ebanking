...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        $result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  account_id = ? AND  tr_type = 'Deposit' ";
        ...
        $account_id = $_GET['account_id'];
        $result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  account_id = ? AND  tr_type = 'Withdrawal' ";
        $stmt = $mysqli->prepare($result);
        $stmt->bind_param('i', $account_id);
        $stmt->execute();
        ...
        $account_id = $_GET['account_id'];
        $result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  account_id = ? AND  tr_type = 'Transfer' ";
        $stmt = $mysqli->prepare($result);
        $stmt->bind_param('i', $account_id);
        $stmt->execute();
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1><?php echo $row->client_name; ?> eBank Account Balance</h1>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-12">
                                ...
                                <div id="balanceSheet" class="invoice p-3 mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <h4>
                                                <i class="fas fa-bank"></i> eBank Corporation Balance Enquiry
