...
if (isset($_GET['deleteBankAccType'])) {
  ...
  $adn = "DELETE FROM  tbl_acc_types  WHERE acctype_id = ?";
  ...
  if ($stmt) {
    $info = "eBank Account Type Removed";
  } else {
    $err = "Try Again Later";
  }
}
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>eBank Account Types</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="pages_manage_accs.php">eBank Account Types</a></li>
