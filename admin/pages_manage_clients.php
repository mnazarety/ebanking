...
if (isset($_GET['deleteClient'])) {
  ...
  $adn = "DELETE FROM  tbl_clients  WHERE client_id = ?";
  ...
  if ($stmt) {
    $info = "eBanking Client Account Deleted";
  } else {
    $err = "Try Again Later";
  }
}
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="pages_manage_clients.php">eBank Staffs</a></li>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-hover table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    //fetch all eBank clients
                    $ret = "SELECT * FROM  tbl_clients ORDER BY RAND() ";
