...
if (isset($_POST['update_acc_type'])) {
    ...
    $query = "UPDATE  tbl_acc_types SET name=?, description=?, rate=? WHERE code=? ";
    ...
    if ($stmt) {
        $success = "eBank Account Category Updated";
    } else {
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <?php
        //fetch a tbl_acc_types
        $code = $_GET['code'];
        $ret = "SELECT * FROM  tbl_acc_types WHERE code = ? ";
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_update_accs.php">eBank Accounts</a></li>
