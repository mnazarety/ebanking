...
if (isset($_POST['systemSettings'])) {
  ...
  if (!$error) {
    ...
    $query = "UPDATE tbl_systemsettings SET sys_name =?, sys_logo =?, sys_tagline=? WHERE id = ?";
          ...
          <div class="col-12">
            <div class="card card-purple card-outline">
              <div class="card-header">
                <h3 class="card-title">Reconfigure System</h3>
              </div>
              <div class="card-body">
                <?php
                        ...
                        <div class="form-group col-md-12">
                          ...
                          <div class="input-group">
                            <div class="custom-file">
                              <input name="sys_logo" type="file" class="custom-file-input">
