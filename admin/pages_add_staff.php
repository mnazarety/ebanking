...
if (isset($_POST['create_staff_account'])) {
    ...
    $query = "INSERT INTO tbl_staff (name, staff_number, phone, email, password, sex, profile_pic) VALUES (?,?,?,?,?,?,?)";
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="pages_add_staff.php">eBank Staff</a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class=" col-md-6 form-group">
                                                ...
                                                ?>
                                                <input type="text" readonly name="staff_number" value="eBank-STAFF-<?php echo $_staffNumber; ?>" class="form-control" id="exampleInputPassword1">
                                            </div>
                                        </div>
