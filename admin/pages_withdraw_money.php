...
if (isset($_POST['withdrawal'])) {
    ...
    */
    ...
    if ($transaction_amt > $amt) {
        ...
        $query = "INSERT INTO tbl_transactions (tr_code, account_id, acc_name, account_number, acc_type,  tr_type, tr_status, client_id, client_name, client_national_id, transaction_amt, client_phone) VALUES (?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    if(isset($_POST['deposit']))
    {
       ...
       $acc_amount = $_POST['acc_amount'];
        ...
        //Insert Captured information to a database table
        $query="UPDATE  tbl_bankaccounts SET acc_amount=? WHERE account_id=?";
        $stmt = $mysqli->prepare($query);
        //bind paramaters
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_deposits">eBank Finances</a></li>
