...
if (isset($_POST['update_staff_account'])) {
    ...
    $query = "UPDATE tbl_staff SET name=?, phone=?, email=?, sex=?, profile_pic=? WHERE staff_number=?";
...
if (isset($_POST['change_staff_password'])) {
    ...
    $query = "UPDATE tbl_staff  SET password=? WHERE  staff_number=?";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
            $staff_number = $_GET['staff_number'];
            $ret = "SELECT * FROM  tbl_staff  WHERE staff_number = ? ";
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_manage_staff.php">eBank Staffs</a></li>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-purple card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <p class="text-muted text-center">Staff @eBanking </p>
