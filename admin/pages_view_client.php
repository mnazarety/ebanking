...
if (isset($_POST['update_client_account'])) {
    ...
    $query = "UPDATE  tbl_clients SET name=?, national_id=?, phone=?, email=?, address=?, profile_pic=? WHERE client_number = ?";
...
if (isset($_POST['change_client_password'])) {
    ...
    $query = "UPDATE tbl_clients  SET password=? WHERE  client_number=?";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
            $client_number = $_GET['client_number'];
            $ret = "SELECT * FROM  tbl_clients  WHERE client_number = ? ";
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_manage_clients.php">eBanking Clients</a></li>
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-purple card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <p class="text-muted text-center">Client @eBanking </p>
