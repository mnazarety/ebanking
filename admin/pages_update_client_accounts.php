...
if (isset($_POST['update_account'])) {
    ...
    $query = "UPDATE  tbl_bankaccounts  SET acc_name=?, account_number=?, acc_type=?, acc_rates=?, acc_status=?, acc_amount=?, client_name=?, client_national_id=?, client_phone=?, client_number=?, client_email=?, client_adr=? WHERE account_id =?";
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <?php
        $account_id = $_GET['account_id'];
        $ret = "SELECT * FROM  tbl_bankaccounts WHERE account_id = ? ";
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Update <?php echo $row->client_name; ?> eBank Account</h1>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="card card-purple">
                                    ...
                                    <form method="post" enctype="multipart/form-data" role="form">
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="update_account" class="btn btn-success">Update eBank Account</button>
                                        </div>
                                    </form>
                                </div>
                                <!-- /.card -->
