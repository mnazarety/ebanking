...
if (isset($_POST['update_account'])) {
    ...
    $query = "UPDATE tbl_admin  SET name=?, email=? WHERE  admin_id=?";
...
if (isset($_POST['change_password'])) {
    ...
    $admin_id = $_SESSION['admin_id'];
    //insert unto certain table in database
    $query = "UPDATE tbl_admin  SET password=? WHERE  admin_id=?";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
            $admin_id = $_SESSION['admin_id'];
            $ret = "SELECT * FROM  tbl_admin  WHERE admin_id = ? ";
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="card card-purple card-outline">
                                    <div class="card-body box-profile">
                                        ...
                                        <p class="text-muted text-center">@Admin eBanking </p>
