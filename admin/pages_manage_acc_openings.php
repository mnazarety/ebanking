...
if (isset($_GET['deleteBankAcc'])) {
  ...
  $adn = "DELETE FROM  tbl_bankaccounts  WHERE account_id = ?";
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Manage eBank Accounts</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="pages_dashboard.php">Dashboard</a></li>
                <li class="breadcrumb-item"><a href="pages_manage_acc_openings.php">eBank Accounts</a></li>
              ...
              <div class="card-body">
                <table id="example1" class="table table-hover table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                    //fetch all iB_Accs
                    $ret = "SELECT * FROM  tbl_bankaccounts ORDER BY RAND() ";
