  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown">
      <a class="nav-link" data-toggle="dropdown" href="#">
        ...
        $result = "SELECT count(*) FROM tbl_notifications";
      ...
      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        <a href="#" class="dropdown-item">
          <!-- Message Start -->
          <?php
          $ret = "SELECT * FROM  tbl_notifications  ";
          $stmt = $mysqli->prepare($ret);
          $stmt->execute(); //ok
          $res = $stmt->get_result();
          $cnt = 1;
          while ($row = $res->fetch_object()) {
            //Tim timestamp to DD-MM-YYY : Hh:iM🧂 
          ...
          ?>
            <div class="media">
              <div class="media-body">
                ...
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i><?php echo date("d-M-Y :: h:i", strtotime($notification_time)); ?></p>
              </div>
            </div>
