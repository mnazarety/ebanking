...
if (isset($_GET['Clear_Notifications'])) {
  ...
  $adn = "DELETE FROM  tbl_notifications  WHERE notification_id = ?";
...
//return total number of eBank clients
$result = "SELECT count(*) FROM tbl_clients";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($eBClients);
$stmt->fetch();
$stmt->close();

//return total number of eBank Staffs
$result = "SELECT count(*) FROM tbl_staff";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($BiStaffs);
$stmt->fetch();
$stmt->close();

//return total number of eBank Account Types
$result = "SELECT count(*) FROM tbl_acc_types";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($eB_AccsType);
$stmt->fetch();
$stmt->close();

//return total number of eBank Accounts
$result = "SELECT count(*) FROM tbl_bankaccounts";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($eB_Accs);
$stmt->fetch();
$stmt->close();

//return total number of eBank Deposits
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  tr_type = 'Deposit' ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($eB_deposits);
$stmt->fetch();
$stmt->close();

//return total number of eBank Withdrawals
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  tr_type = 'Withdrawal' ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($eB_withdrawal);
$stmt->fetch();
$stmt->close();



//return total number of eBank Transfers
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions WHERE  tr_type = 'Transfer' ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
$stmt->bind_result($eB_Transfers);
$stmt->fetch();
$stmt->close();

//return total number of  eBank initial cash->balances
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
...
$TotalBalInAccount = ($eB_deposits)  - (($eB_withdrawal) + ($eB_Transfers));


//eBank money in the wallet
$result = "SELECT SUM(transaction_amt) FROM tbl_transactions ";
$stmt = $mysqli->prepare($result);
$stmt->execute();
            ...
            <div class="col-12 col-sm-6 col-md-4">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $eB_AccsType; ?></span>
                </div>
              </div>
            </div>
            <!-- /.eBank Acc types -->
            ...
            <div class="col-12 col-sm-6 col-md-4">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number"><?php echo $eB_Accs; ?></span>
                </div>
              </div>
            </div>
            <!-- eBank Acc-->
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">Ksh <?php echo $eB_withdrawal; ?> </span>
                </div>
              </div>
            </div>
            <!-- Withdrawals-->
            ...
            <div class="col-12 col-sm-6 col-md-3">
              <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number">Ksh <?php echo $eB_Transfers; ?></span>
                </div>
              </div>
            </div>
            <!-- /.Transfers-->
                  ...
                  <div class="row">
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">Ksh <?php echo $eB_deposits; ?></h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">Ksh <?php echo $eB_withdrawal; ?></h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block border-right">
                        <h5 class="description-header">Ksh <?php echo $eB_Transfers; ?> </h5>
                    ...
                    <div class="col-sm-3 col-6">
                      <div class="description-block">
                        ...
                        <span class="description-text">TOTAL MONEY IN eBank Account</span>
                      </div>
                      <!-- /.description-block -->
                    </div>
                  </div>
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-bordered m-0">
                      ...
                      <tbody>
                        ...
                        $ret = "SELECT * FROM `tbl_transactions` ORDER BY `tbl_transactions`.`created_at` DESC ";
        ...
        data: [{
          ...
          dataPoints: [{
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type ='Savings'";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type =' Retirement'  ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type ='Recurring deposit' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type ='Fixed Deposit Account' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM tbl_bankaccounts WHERE  acc_type ='Current account' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
        ...
        data: [{
          ...
          dataPoints: [{
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM tbl_transactions WHERE  tr_type ='Withdrawal' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  ...
                  $result = "SELECT count(*) FROM tbl_transactions WHERE  tr_type ='Deposit' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
...

            {
              y: <?php
                  //return total number of transactions under  Deposits
                  $result = "SELECT count(*) FROM tbl_transactions WHERE  tr_type ='Transfer' ";
                  $stmt = $mysqli->prepare($result);
                  $stmt->execute();
