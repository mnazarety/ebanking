...
if (isset($_POST['update_staff_account'])) {
    ...
    $query = "UPDATE tbl_staff SET name=?, phone=?, email=?, sex=?, profile_pic=? WHERE staff_id=?";
...
if (isset($_POST['change_staff_password'])) {
    ...
    $query = "UPDATE tbl_staff  SET password=? WHERE  staff_id=?";
    $stmt = $mysqli->prepare($query);
    //bind paramaters
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php
            $staff_id = $_SESSION['staff_id'];
            $ret = "SELECT * FROM  tbl_staff  WHERE staff_id = ? ";
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item"><a href="pages_manage.php">eBank Staffs</a></li>
